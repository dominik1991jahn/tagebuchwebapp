	...
	function CreateFooter(currentDate)
	{
	 	...
	 	linkprev = $("<a href=\"#"+prevID+"\" data-role=\"button\" data-icon=\"arrow-l\" data-iconpos=\"left\" class=\"ui-btn-left\">"+DayOfWeekToName(prevdate.getDay()) + " (" + Zero(prevdate.getDate()) + "." + Zero((prevdate.getMonth()+1))  + ")</a>");
		...
		linknext = $("<a href=\"#"+nextID+"\" data-role=\"button\" data-icon=\"arrow-r\" data-iconpos=\"right\" class=\"ui-btn-right\">"+DayOfWeekToName(nextdate.getDay()) + " (" + Zero(nextdate.getDate()) + "." + Zero((nextdate.getMonth()+1))  + ")</a>");
